...
def unpack_text_field(sequence, idx, structure, name, **kwargs):
    # type: (dict[int, ASN1Value], int, str, str, Optional[str]) -> Optional[str]
...
def unpack_sequence(data):  # type: (Union[ASN1Value, bytes]) -> dict[int, ASN1Value]
...
class NegoData:
    ...
    def __init__(self, nego_token):  # type: (bytes) -> None
    ...
    @staticmethod
    def unpack(b_data):  # type: (Union[ASN1Value, bytes]) -> NegoData
...
class TSRequest:
    ...
    def __init__(self, version, nego_tokens=None, auth_info=None, pub_key_auth=None, error_code=None,
                 client_nonce=None):
        # type: (int, Optional[Union[NegoData, List[NegoData]]], Optional[bytes], Optional[bytes], Optional[int], Optional[bytes]) -> None  # noqa
    ...
    @staticmethod
    def unpack(b_data):  # type: (Union[ASN1Value, bytes]) -> TSRequest
...
class TSCredentials:
    ...
    def __init__(self, credentials):  # type: (Union[TSPasswordCreds, TSSmartCardCreds, TSRemoteGuardCreds]) -> None
        self.credentials = credentials

    @property
    def cred_type(self):  # type: () -> int
    ...
    @staticmethod
    def unpack(b_data):  # type: (Union[ASN1Value, bytes]) -> TSCredentials
...
class TSPasswordCreds:
    ...
    Attributes:
        domain_name (bytes): See args.
        username (bytes): See args.
        password (bytes): See args.

    .. _MS-CSSP 2.2.1.2.1 TSPasswordCreds:
        https://docs.microsoft.com/en-us/openspecs/windows_protocols/ms-cssp/9664994d-0784-4659-b85b-83b8d54c2336
    """

    def __init__(self, domain_name, username, password):  # type: (str, str, str) -> None
    ...
    @staticmethod
    def unpack(b_data):  # type: (Union[ASN1Value, bytes]) -> TSPasswordCreds
...
class TSSmartCardCreds:
    ...
    def __init__(self, pin, csp_data, user_hint=None, domain_hint=None):
        # type: (str, TSCspDataDetail, Optional[str], Optional[str]) -> None
        self.pin = pin
    ...
    @staticmethod
    def unpack(b_data):  # type: (Union[ASN1Value, bytes]) -> TSSmartCardCreds
...
class TSCspDataDetail:
    ...
    def __init__(self, key_spec, card_name=None, reader_name=None, container_name=None, csp_name=None):
        # type: (int, Optional[str], Optional[str], Optional[str], Optional[str]) -> None
    ...
    @staticmethod
    def unpack(b_data):  # type: (Union[ASN1Value, bytes]) -> TSCspDataDetail
...
class TSRemoteGuardCreds:
    ...
    def __init__(self, logon_cred, supplemental_creds=None):
        # type: (TSRemoteGuardPackageCred, Optional[Union[TSRemoteGuardPackageCred, List[TSRemoteGuardPackageCred]]]) -> None  # noqa
    ...
    @staticmethod
    def unpack(b_data):  # type: (Union[ASN1Value, bytes]) -> TSRemoteGuardCreds
...
class TSRemoteGuardPackageCred:
    ...
    def __init__(self, package_name, cred_buffer):  # type: (str, bytes) -> None
    ...
    @staticmethod
    def unpack(b_data):  # type: (Union[ASN1Value, bytes]) -> TSRemoteGuardPackageCred
