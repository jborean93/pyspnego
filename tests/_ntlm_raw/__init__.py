...
TEST_NTLMV1_FLAGS = NegotiateFlags.key_exch | NegotiateFlags.key_56 | NegotiateFlags.key_128 | \
    NegotiateFlags.version | NegotiateFlags.target_type_server | NegotiateFlags.always_sign | NegotiateFlags.ntlm | \
